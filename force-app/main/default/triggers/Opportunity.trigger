trigger Opportunity on Opportunity (before insert, before update, after update) {
  ...
  if (trigger.isUpdate) {
    ...
    for(Opportunity Opp : Trigger.new) {if (trigger.oldMap.get(Opp.Id).StageName == 'Value Proposition' &&
    Opp.Stagename == 'Negotiation/Review') {
      ...
      //if(!attachments.isEmpty()) {  
          ...
          email.setPlainTextBody('Prezado/a.' +
...
'\n\n' + 'Atenciosamente, ' + Opp.Owner);
      ...
      else if (trigger.oldMap.get(Opp.Id).StageName != 'Closed Lost' &&
      Opp.StageName == 'Closed Lost') {
        ...
        //if(!attachments.isEmpty()) {  
            ...
            email.setPlainTextBody('Prezado/a.' +
            '\n\n' + 'Viemos pelo seguinte email informar que não foi possivel dar continuidade ' +
